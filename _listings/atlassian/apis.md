...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/apis.md
...
- name: Jira Cloud REST API - Move screen tab field
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2screensscreenidtabstabidfieldsidmove-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2screensscreenidtabstabidfieldsidmove-post-openapi.md
- name: Jira Cloud REST API - Move screen tab
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2screensscreenidtabstabidmovepos-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2screensscreenidtabstabidmovepos-post-openapi.md
- name: Jira Cloud REST API - Move version
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2versionidmove-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/move/master/_listings/atlassian/api2versionidmove-post-openapi.md
x-common:
- type: x-openapi
